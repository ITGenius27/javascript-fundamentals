...
/* Variables created toassign to an object
separated by comas */
const something = {},
   str = 'secondString',
   rand = Math.random(),
...
something.tye = 'Dot syntax for a key called type.';
...
/*dynamcally create properties using intializer version */
...
function showSomething(obj, objName) {
    let result = '';
    for(const i in obj) {
        /*obj.hasOwn mehod is used to exclude propertes
        from the object's prototypechain, and only show
...
/* child method is not accessible through the parent */
