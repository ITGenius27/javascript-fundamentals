...
/* Concurrency is a concept of asynchonous programming */

/* Callbacks */
/* Callbacks are asynchronous functions that
call back after the executio completes */
...
/* The below switch uses expression different than a standard switch.
Thi is achieved by passing a boolean true into the switch. Because of
...
let myPromise = new Promise((resolve,reject) => {
    ...
    setTimeout(() => {
        ...
        if(able > 10) {
            ...
            reject('Promise value is not highenough.');
        }
...
in a cleaner style that doesn't need th promise chains. */
